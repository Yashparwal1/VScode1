...
def main():
    while True:
        ...
        list_vulns = ["XSS", "XXE - XML", "HTML Injection", "SQL Injection", "Command Injection", "HTTP Smuggling", "HTTP Parameter Pollution", "Open Redirection", "LFI", "Go Back"]
        ...
        if vulns == "0":
                ...
                if ask == '1':
                    while True:
                        ...
                        for i in range(len(list_tools)):
                            print(colors.options,f"{i}) {list_tools[i]}".title(), colors.reset)
                        option = input(f"\n {colors.select}Select an Option ->{colors.reset} ")
                        if option == '0':
                            print("\n[+] Dalfox")
                            github = github_getting_text("https://github.com/hahwul/dalfox", 'p[dir="auto"]', 1)
                            template.template("dalfox", "dalfox -h", github.strip(), {
                            ...
                            } , link="github.com/hahwul/dalfox/v2@latest", method="go")
                        elif option == '1':
                            print("\n[+] XSStrike")
                            github = github_getting_text("https://github.com/s0md3v/XSStrike", 'p[dir=auto]', 3) 
                            template.template("XSStrike", "python3 xsstrike.py -h", github.strip(), {
                            ...
                            }, link="https://github.com/s0md3v/XSStrike.git", method="github", github_install="git clone https://github.com/s0md3v/XSStrike.git", github_check="XSStrike")
                        elif option == '2':
                            print("\n[+] Xsser")
                            github = github_getting_text("https://www.kali.org/tools/xsser/", 'p', 3) 
                            template.template("Xsser", "xsser -h", github.strip(), {
                    ...
                    writeup.writeup({'The popping history of XSS':'https://thexssrat.medium.com/the-popping-history-of-xss-4122e34ac586',
            ...
            template.template("XXE", "no-tools", github.strip(), {'XXE':'https://phonexicum.github.io/infosec/xxe.html',
            ...
            template.template("HTML Injection", "no-tools", github.strip(), {'Comprehensive Guide on HTML Injection':'https://www.hackingarticles.in/comprehensive-guide-on-html-injection/',
                ...
                if ask == '1':
                    while True:
                        ...
                        if option == '0':
                            ...
                            template.template("Sqlmap", "sqlmap -h", github.strip(), {
                    ...
                    writeup.writeup({'SQL Injection Cheatsheet':'https://www.invicti.com/blog/web-security/sql-injection-cheat-sheet/',
            ...
            while True:
                ...
                if ask == '1':
                    while True:
                        ...
                        if option == '0':
                            print("\n[+] Commix")
                            github = github_getting_text("https://github.com/commixproject/commix", 'p[dir=auto]', 3)
                            template.template("Commix", "python commix.py -h", github.strip(), {
                            ...
                            }, link="https://github.com/commixproject/commix.git",method = "github", github_install="git clone https://github.com/commixproject/commix.git", github_check="commix")
                        else:
                            # print(f"{colors.red}[-]Wrong Input{colors.reset}")
                            break                
                elif ask == '2':
                    writeup.writeup({'Breaking down — Command Injections':'https://infosecwriteups.com/breaking-down-command-injections-97d1029576',
            ...
            template.template("HTTP Request Smuggling", "no-tools", github.strip(), {'HTTP request smuggling Explained':'https://infosecwriteups.com/http-request-smuggling-explained-and-exploited-part-0x1-89ce2956534f',
            ...
            template.template("HTTP Parameter Pollution", "no-tools", github.strip(), {'Behind the Scene : HTTP Parameter Pollution':'https://infosecwriteups.com/behind-the-scene-http-parameter-pollution-534b4fa2449c',
            ...
            while True:
                ...
                if ask == '1':
                    while True:
                        ...
                        if option == '0':
                            print("\n[+] OpenRedireX")
                            github = github_getting_text("https://github.com/devanshbatham/OpenRedireX", "ul[dir=auto]", 0)
                            template.template("OpenRedireX", "python3 openredirex.py -h", github.strip(), {
                            ...
                            }, link="https://github.com/devanshbatham/OpenRedireX", method="github", github_install="git clone https://github.com/devanshbatham/OpenRedireX.git", github_check="OpenRedireX")
                        elif option == '1':
                            print("\n[+] Oralyzer")
                            github = github_getting_text("https://github.com/r0075h3ll/Oralyzer", "p[dir=auto]", 0)
                            template.template("Oralyzer", "python3 oralyzer.py -h", github.strip(), {
                            ...
                            }, link="https://github.com/r0075h3ll/Oralyzer.git", method="github", github_install="git clone https://github.com/r0075h3ll/Oralyzer.git", github_check="Oralyzer")
                        else:
                            # print(f"{colors.red}[-]Wrong Input{colors.reset}")
                            break
                elif ask == '2':
                    writeup.writeup({'Open redirect - Improper validation of front-end provided redirect links':'https://learn.snyk.io/lessons/open-redirect/javascript/',
            ...
            template.template("LFI", "no-tools", github.strip(), {'LFI Attack Examples':'https://brightsec.com/blog/lfi-attack-real-life-attacks-and-attack-examples/',
