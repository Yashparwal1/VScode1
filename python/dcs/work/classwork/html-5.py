...
def main():
    while True:
        ...
        list_vulns = ["WEB Messaging", "WEB Storage SQL Injection",
                      "CORS Implementation", "Offline Web Applicatipn", "Go back"]
        for i in range(len(list_vulns)):
            print(colors.options,
                  f"{i}) {list_vulns[i]}".title(), colors.reset)
        ...
        if vulns == "0":
            ...
            template.template("WEB Messaging", "no-tools", github.strip(), {'HTML5 - Web messaging': 'https://www.tutorialspoint.com/html5/html5_web_messaging.htm',
            ...
            template.template("WEB Storage SQL Injection", "no-tools", github.strip(), {'Testing Browser Storage': 'https://owasp.org/www-project-web-security-testing-guide/v41/4-Web_Application_Security_Testing/11-Client_Side_Testing/12-Testing_Browser_Storage',
