...
[ek naam -- anek kaam] (1 name -- multiple forms)
...
* Compile-time polymorphism is also called early binding, which means that you are already bound to the function call and you know that this function is going to run. 
...
===> Run Time (Dynamic) Polymorphism (late binding or dynamic binding) <===

****[function call ke decision ko bohot defer kr deta h.. that's why taking decision at run time]
